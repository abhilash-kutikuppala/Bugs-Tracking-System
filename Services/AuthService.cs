...
using BugsTrackingSystem.Configurations;
using BugsTrackingSystem.DAL;
using BugsTrackingSystem.Exceptions;
using BugsTrackingSystem.Models;
using BugsTrackingSystem.ViewModels;
...
namespace BugsTrackingSystem.Services
{
    public class AuthService : IAuthService
    {
        ...
        public AuthService(BugsResolvingContext context, ILoggerFactory loggerFactory, IOptions<AppSettings> options)
        {
            _context = context;
        ...
        private JwtViewModel GetToken(User userDb)
        {
            ...
            var key = new SymmetricSecurityKey(Encoding.UTF8.GetBytes("2640a70a-88b4-4a74-b1f7-b4bcfb94eb76-b1e583cc-a1f3-4c54-8470-0ccb513eb114-4e7a9517-fd2e-4ec3-803e-0d6009ccb316"));
